                        ...
                        <div className="row">
                            <div className="col-lg-2">
                                <div className="gallery-filters case-menu">
                                    <ul>
                                        <li><Link href="/" className="current" onClick={allElement}>All Project</Link></li>
                                    ...
                                    {Cases.map((Case, citem) => (
                                        ...
                                        <div className="img-holder">
                                                ...
                                                <div className="hover-content">
                                                    <Link onClick={ClickHandler} className="theme-btn" href="/case/[slug]" as={`/case/${Case.slug}`}>{Case.cTitle}</Link>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
