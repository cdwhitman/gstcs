            ...
            <div className='wpo-blog-content'>
                ...
                <div className='entry-meta'>
                  <ul>
                    <li>
                      ...
                      <Link href='/blog-single/1'>{BlogDetails.author}</Link>{' '}
                    </li>
                    <li>
              ...
              <div className='tag-share clearfix'>
                <div className='tag'>
                  ...
                  <ul>
                    <li>
                      <Link href='/blog-single/1'>Planning</Link>
                    </li>
                    <li>
                      <Link href='/blog-single/1'>Business</Link>
                    </li>
                    <li>
                      <Link href='/blog-single/1'>ContactForm</Link>
                    </li>
                  </ul>
                </div>
              </div>
              <div className='tag-share-s2 clearfix'>
                <div className='tag'>
                  ...
                  <ul>
                    <li>
                      <Link href='/blog-single/1'>facebook</Link>
                    </li>
                    <li>
                      <Link href='/blog-single/1'>twitter</Link>
                    </li>
                    <li>
                      <Link href='/blog-single/1'>linkedin</Link>
                    </li>
                    <li>
                      <Link href='/blog-single/1'>pinterest</Link>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className='author-box'>
                <div className='author-avatar'>
                  <Link href='/blog-single/1' target='_blank'>
                    <img src={blog6} alt='' />
                  </Link>
                </div>
                <div className='author-content'>
                  <Link href='/blog-single/1' className='author-name'>
                    Author: Jenny Watson
                  </Link>
                  <p>
